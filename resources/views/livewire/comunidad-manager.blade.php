    ...
    <fieldset style="border: 2px solid #8b0000; border-radius: 6px; padding: 10px;">
        ...
        <table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size: 11px;">
            ...
            <tr>
                ...
                <td>
                    <input wire:model="nombre_encargado" type="text" style="width: 90%;">
                    @error('nombre_encargado')<br><span style="color:red;font-size:10px;">{{ $message }}</span>@enderror
                </td>
                <td><b>Apellido del encargado:</b></td>
                <td>
                    <input wire:model="apellido_encargado" type="text" style="width: 90%;">
                    @error('apellido_encargado')<br><span style="color:red;font-size:10px;">{{ $message }}</span>@enderror
                </td>
            </tr>
            <tr>
                <td><b>Teléfono del encargado:</b></td>
                <td colspan="3">
                    <input wire:model="telefono_encargado" type="text" style="width: 40%;">
                    @error('telefono_encargado')<br><span style="color:red;font-size:10px;">{{ $message }}</span>@enderror
                </td>
            </tr>
            <tr>
